...
class GAT(object):
    ...
    def __init__(self, config, num_class):
        ...
        self.feat_dropout = config.get("feat_drop", 0.0)
        self.attn_dropout = config.get("attn_drop", 0.0)
        self.edge_dropout = config.get("edge_dropout", 0.0)
...
class GATGCN(object):
    ...
    def forward(self, graph_wrapper, feature, phase):
        ...
        feature = conv.gat(ngw,
                     ...
                     attn_drop=self.attn_dropout,
                     name="output")
        feature=L.fc(feature,self.num_class)
        return feature
